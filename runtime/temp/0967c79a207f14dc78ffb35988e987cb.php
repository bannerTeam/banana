<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:61:"D:\wamp\www\banana/application/admin\view\collect\timing.html";i:1525393550;s:58:"D:\wamp\www\banana\application\admin\view\public\head.html";i:1522628861;s:58:"D:\wamp\www\banana\application\admin\view\public\foot.html";i:1526021730;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<script language="javascript">
    ...
    var urln=0,typeids='<?php echo $vod_type_ids_today; ?>';
    var cjUrl = "<?php echo url('collect/apis'); ?>";
    ...
    function makeinfo()
    {
        $("#sp_makeinfo").html("<iframe width='100%' height='200' src='<?php echo url('make/make'); ?>?ac=info&tab=vod&ac2=nomake' scrolling='auto'></iframe>");
    }
    function makeindex()
    {
        $("#sp_makeindex").html("<iframe width='100%' height='200' src='<?php echo url('make/make'); ?>?ac=index' scrolling='auto'></iframe>");
    }
    function maketype()
    {
        if(typeids==''){
            ...
            $("#sp_maketype").html("<iframe width='100%' height='200' src='<?php echo url('make/make'); ?>?ac=type&tab=vod&vodtype="+typeids+"' scrolling='auto'></iframe>");
        }
    }
    function reflogin()
    {
        $("#sp_reflogin").html("<iframe width='100%' height='100' src='<?php echo url('index/welcome'); ?>' scrolling='auto' style='display:none'></iframe>");
    }
...
<div class="page-container p10">
    <div style="width:650px; height:420px; margin:0 auto;">
        ...
        <table style="">
            <tr>
                <td width="50%" rowspan="4"> <div style=""> <script src="http://www.maccms.com/union/xmlutf_2014.js" charset="utf-8"></script> </div></td>
                <td>采集抓取频率(分钟/次)：</td>
