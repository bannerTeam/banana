...
<html>
  ...
  <head>
    ...
    <title><?php echo $maccms['site_name']; ?>-<?php echo $obj['type_name']; ?></title>
    ...
    <section class="container">
      <div class="fenlei">
        <div class="b-listfilter" style="padding: 0px;">
          <style>#noall{ background-color: #aik651; color: #fff; }</style>
          <dl class="b-listfilter-item js-listfilter" style="padding-left: 0px;height:auto;padding-right:0px;">
            <dd class="item g-clear js-listfilter-content" style="margin: 0;">
              ...
              <a href='<?php echo mac_url_type($obj); ?>' class="menu-itema" target='_self'>全部</a> 
        ...
        <a href="<?php echo mac_url_type($vo,[],'show'); ?>" target='_self'><?php echo $vo['type_name']; ?></a>
		<?php endforeach; endif; else: echo "" ;endif; ?>
        
                <a href='<?php echo mac_url_type($obj,['area'=>$param['area'],'lang'=>$param['lang'],'year'=>$param['year'],'level'=>$param['level'],'letter'=>$param['letter'],'state'=>$param['state'],'tag'=>$param['tag'],'class'=>'','order'=>$param['order'],'by'=>$param['by'] ],'show'); ?>' target='_self'>片库</a></dd>
          </dl>
        </div>
      </div>
      <div class="m-g">
            ...
            <div>
              <div class="s-tab-main">
                <ul class="list g-clear">
					 ...
					 <?php $__TAG__ = '{"num":"48","paging":"yes","pageurl":"vod\/show","type":"current","order":"desc","by":"time"}';$__LIST__ = model("Vod")->listCacheData($__TAG__);$__PAGING__ = mac_page_param($__LIST__['total'],$__LIST__['limit'],$__LIST__['page'],$__LIST__['pageurl'],$__LIST__['half']); if(is_array($__LIST__['list']) || $__LIST__['list'] instanceof \think\Collection || $__LIST__['list'] instanceof \think\Paginator): $key = 0; $__LIST__ = $__LIST__['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($key % 2 );++$key;?>
                  <li class='item'>
